...
def publication_receipt_material(plan, authorization, **changes):
    value = {
        ...
        "transaction_ref": authorization.transaction_ref,
        "transaction_digest": authorization.transaction_digest,
        "committed_head": SOURCE_HEAD,
        "commit_receipt_digest": "9" * 64,
...
def import_receipt_material(plan, authorization, **changes):
    value = {
        ...
        "committed_head": SOURCE_HEAD,
        "commit_receipt_digest": "9" * 64,
        "publication_receipt_ref": "publication-receipt:synthetic:one",
        "publication_receipt_digest": "8" * 64,
        "projection_ref": plan.projection_ref,
        "projection_digest": plan.projection_digest,
